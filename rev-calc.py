...
abilities: List[str] = ["ANTICIPATION", "ASPHYXIATE", "ASSAULT", "BACKHAND","BALANCED STRIKE", "BARGE", "BASH", "BERSERK", "BINDING SHOT", "BLOOD TENDRILS",
                        ...
                        "DEEP IMPACT", "DEMORALISE", "DESTROY", "DETONATE", "DISMEMBER", "DRAGON BREATH", "FLURRY",
